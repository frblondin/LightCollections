...
namespace System.Collections.Tests
{
    ...
    public abstract partial class LightDictionary_Generic_Tests<TKey, TValue> : IDictionary_Generic_Tests<TKey, TValue>
    {
        ...
        {
            return new LightDictionary<TKey, TValue>();
        }
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void LightDictionary_Generic_Constructor_IDictionary_IEqualityComparer(int count)
        {
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void LightDictionary_Generic_Constructor_int(int count)
        {
            IDictionary<TKey, TValue> dictionary = new LightDictionary<TKey, TValue>(count);
