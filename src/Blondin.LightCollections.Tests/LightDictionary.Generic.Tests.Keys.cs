...
{
    public class LightDictionary_Generic_Tests_Keys : ICollection_Generic_Tests<string>
    {
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void LightDictionary_Generic_KeyCollection_GetEnumerator(int count)
        {
    ...
    public class LightDictionary_Generic_Tests_Keys_AsICollection : ICollection_NonGeneric_Tests
    {
        ...
        {
            return new LightDictionary<string, string>().Keys;
        }
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void LightDictionary_Generic_KeyCollection_CopyTo_ExactlyEnoughSpaceInTypeCorrectArray(int count)
        {
