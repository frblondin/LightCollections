...
{
    public class LightDictionary_Generic_Tests_string_string : LightDictionary_Generic_Tests<string, string>
    {
    ...
    public class LightDictionary_Generic_Tests_int_int : LightDictionary_Generic_Tests<int, int>
    {
    ...
    public class LightDictionary_Generic_Tests_SimpleInt_int_With_Comparer_WrapStructural_SimpleInt : LightDictionary_Generic_Tests<SimpleInt, int>
    {
