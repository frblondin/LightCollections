...
{
    public class LightDictionary_Generic_Tests_Values : ICollection_Generic_Tests<string>
    {
        ...
        {
            return new LightDictionary<string, string>().Values;
        }
        ...
        public void LightDictionary_Generic_ValueCollection_Constructor_NullDictionary(int count)
        {
            Assert.Throws<ArgumentNullException>(() => new LightDictionary<string, string>.ValueCollection(null));
        }
    ...
    public class LightDictionary_Generic_Tests_Values_AsICollection : ICollection_NonGeneric_Tests
    {
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void LightDictionary_Generic_ValueCollection_CopyTo_ExactlyEnoughSpaceInTypeCorrectArray(int count)
        {
